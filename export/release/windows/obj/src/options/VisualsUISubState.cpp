...
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_125_onChangePauseMusic,"options.VisualsUISubState","onChangePauseMusic",0xdfdbfe24,"options.VisualsUISubState.onChangePauseMusic","options/VisualsUISubState.hx",125,0x3f30f917)
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_135_destroy,"options.VisualsUISubState","destroy",0x298befb4,"options.VisualsUISubState.destroy","options/VisualsUISubState.hx",135,0x3f30f917)
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_143_onChangeFPSCounter,"options.VisualsUISubState","onChangeFPSCounter",0xf92afa68,"options.VisualsUISubState.onChangeFPSCounter","options/VisualsUISubState.hx",143,0x3f30f917)
namespace options{

void VisualsUISubState_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4e14480e50e84747_30_new)
HXLINE( 123)		this->changedMusic = false;
...
void VisualsUISubState_obj::onChangePauseMusic(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_125_onChangePauseMusic)
HXLINE( 126)		if ((::ClientPrefs_obj::pauseMusic == HX_("None",d8,3e,e3,33))) {
HXLINE( 127)			::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
            		}
            		else {
HXLINE( 129)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 129)			::String library = null();
HXDLIN( 129)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::ClientPrefs_obj::pauseMusic.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)),HX_(".",2e,00,00,00),HX_("",00,00,00,00)),HX_("?",3f,00,00,00),HX_("",00,00,00,00)),HX_("!",21,00,00,00),HX_("",00,00,00,00)),HX_("\\",5c,00,00,00),HX_("",00,00,00,00)),HX_("/",2f,00,00,00),HX_("",00,00,00,00)),library);
HXDLIN( 129)			_hx_tmp->playMusic(file,null(),null(),null());
            		}
HXLINE( 131)		this->changedMusic = true;
            	}
...
void VisualsUISubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_135_destroy)
HXLINE( 136)		if (this->changedMusic) {
HXLINE( 136)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 136)			::String library = null();
HXDLIN( 136)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
...
void VisualsUISubState_obj::onChangeFPSCounter(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_143_onChangeFPSCounter)
HXDLIN( 143)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE( 144)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
