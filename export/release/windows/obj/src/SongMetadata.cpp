...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_543_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",543,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_543_new)
HXLINE( 549)		this->folder = HX_("",00,00,00,00);
HXLINE( 548)		this->color = -7179779;
HXLINE( 547)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 546)		this->week = 0;
HXLINE( 545)		this->songName = HX_("",00,00,00,00);
HXLINE( 553)		this->songName = song;
HXLINE( 554)		this->week = week;
HXLINE( 555)		this->songCharacter = songCharacter;
HXLINE( 556)		this->color = color;
HXLINE( 557)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 558)		if (::hx::IsNull( this->folder )) {
HXLINE( 558)			this->folder = HX_("",00,00,00,00);
            		}
            	}
