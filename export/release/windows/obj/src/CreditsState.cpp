...
HXDLIN( 117)						optionText->set_x(((( (Float)(_hx_tmp) ) - optionText->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN( 117)						optionText->set_y(((( (Float)(_hx_tmp) ) - optionText->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE( 155)		 ::flixel::text::FlxText _hx_tmp3 = this->descText;
HXDLIN( 155)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN( 155)		::String _hx_tmp4;
HXDLIN( 155)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 155)			_hx_tmp4 = file;
            		}
            		else {
HXLINE( 155)			_hx_tmp4 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN( 155)		_hx_tmp3->setFormat(_hx_tmp4,32,-1,HX_("center",d5,25,db,05),null(),null(),null());
...
HXLINE( 161)		 ::flixel::FlxSprite _hx_tmp5 = this->bg;
HXDLIN( 161)		_hx_tmp5->set_color(( (int)(this->getCurrentBGColor()) ));
...
HXLINE( 232)						{
HXLINE( 232)							 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 232)							if (::hx::IsNull( axes )) {
HXLINE( 232)								axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            							}
HXDLIN( 232)							bool _hx_tmp;
HXDLIN( 232)							switch((int)(axes->_hx_getIndex())){
            								case (int)0: case (int)2: {
...
HXLINE( 232)								int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 232)								item->set_x(((( (Float)(_hx_tmp) ) - item->get_width()) / ( (Float)(2) )));
            							}
...
HXLINE( 232)								int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 232)								item->set_y(((( (Float)(_hx_tmp) ) - item->get_height()) / ( (Float)(2) )));
            							}
            						}
