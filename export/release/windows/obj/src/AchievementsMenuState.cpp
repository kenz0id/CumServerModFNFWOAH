...
HXDLIN(  55)				 ::Alphabet optionText1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((100 * i) + 210)) ),optionText,false,false,null(),null());
...
HXLINE(  69)		 ::flixel::text::FlxText _hx_tmp2 = this->descText;
...
HXLINE(  69)			_hx_tmp3 = file;
            		}
            		else {
HXLINE(  69)			_hx_tmp3 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  69)		_hx_tmp2->setFormat(_hx_tmp3,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
