...
HXLINE(  81)		bg1->screenCenter(null());
...
HXLINE(  90)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
...
HXDLIN(  90)		this->magenta = _hx_tmp2->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
HXLINE(  91)		this->magenta->scrollFactor->set(0,yScroll);
HXLINE(  92)		 ::flixel::FlxSprite _hx_tmp3 = this->magenta;
HXDLIN(  92)		_hx_tmp3->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.175))),null());
HXLINE(  93)		this->magenta->updateHitbox();
HXLINE(  94)		this->magenta->screenCenter(null());
...
HXLINE( 121)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE( 149)			_hx_tmp4 = (leDate->getHours() >= 18);
            		}
            		else {
...
HXLINE( 271)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
