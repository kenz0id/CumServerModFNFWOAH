...
HXLINE( 164)				 ::flixel::math::FlxPoint fh = this->velocity;
HXDLIN( 164)				fh->set_x((fh->x + ((( ( ::flixel::math::FlxPoint)(this->velocityRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->velocityRange->start) )->x) * this->_delta)));
HXLINE( 165)				 ::flixel::math::FlxPoint fh1 = this->velocity;
HXDLIN( 165)				fh1->set_y((fh1->y + ((( ( ::flixel::math::FlxPoint)(this->velocityRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->velocityRange->start) )->y) * this->_delta)));
            			}
...
HXLINE( 175)				 ::flixel::math::FlxPoint fh = this->scale;
HXDLIN( 175)				fh->set_x((fh->x + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->x) * this->_delta)));
HXLINE( 176)				 ::flixel::math::FlxPoint fh1 = this->scale;
HXDLIN( 176)				fh1->set_y((fh1->y + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->y) * this->_delta)));
...
HXLINE( 193)				 ::flixel::math::FlxPoint fh = this->drag;
HXDLIN( 193)				fh->set_x((fh->x + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->x) * this->_delta)));
HXLINE( 194)				 ::flixel::math::FlxPoint fh1 = this->drag;
HXDLIN( 194)				fh1->set_y((fh1->y + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->y) * this->_delta)));
            			}
HXLINE( 197)			if (this->accelerationRange->active) {
HXLINE( 199)				 ::flixel::math::FlxPoint fh = this->acceleration;
HXDLIN( 199)				fh->set_x((fh->x + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->x) * this->_delta)));
HXLINE( 200)				 ::flixel::math::FlxPoint fh1 = this->acceleration;
HXDLIN( 200)				fh1->set_y((fh1->y + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->y) * this->_delta)));
            			}
