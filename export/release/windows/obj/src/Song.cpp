...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_90_loadFromJson)
HXLINE(  91)		::String rawJson = null();
HXLINE(  93)		::String formattedFolder = ::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(folder.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)),HX_(".",2e,00,00,00),HX_("",00,00,00,00)),HX_("?",3f,00,00,00),HX_("",00,00,00,00)),HX_("!",21,00,00,00),HX_("",00,00,00,00)),HX_("\\",5c,00,00,00),HX_("",00,00,00,00)),HX_("/",2f,00,00,00),HX_("",00,00,00,00));
HXLINE(  94)		::String formattedSong = ::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(::StringTools_obj::replace(jsonInput.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)),HX_(".",2e,00,00,00),HX_("",00,00,00,00)),HX_("?",3f,00,00,00),HX_("",00,00,00,00)),HX_("!",21,00,00,00),HX_("",00,00,00,00)),HX_("\\",5c,00,00,00),HX_("",00,00,00,00)),HX_("/",2f,00,00,00),HX_("",00,00,00,00));
