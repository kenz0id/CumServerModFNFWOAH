...
HXLINE(  81)		{
HXLINE(  81)			::String v8 = (::ManifestResources_obj::rootPath + HX_("manifest/week7.json",53,1e,57,58));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week7",c3,95,be,c7),v8);
            		}
HXLINE(  82)		{
...
HXLINE( 109)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week7",c3,95,be,c7));
HXLINE( 110)		if (::hx::IsNotNull( library )) {
HXLINE( 110)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 111)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week7",c3,95,be,c7));
            		}
